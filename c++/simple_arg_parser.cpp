...
int main(const int argc, const char** argv) {
	...
	p.add_arg_obj(t_arg_obj("num_iters", "12345"));
	p.add_arg_obj(t_arg_obj("min_delta", "0.05f"));
	p.add_arg_obj(t_arg_obj("win_title", "title"));
	p.add_arg_alias("num_iters", "--i");
	p.add_arg_alias("min_delta", "--d");
	p.add_arg_alias("win_title", "--t");
