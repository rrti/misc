...
term = ("wings", FileVersion, FileData)
	FileData = (Shapes, Materials, Props)
		Shapes = [Object1, Object2, ...]
			ObjectK = ("object", "objectName", objectData, extraData)
				objectData = ("winged", edgeLists, faceMatLists, vertLists, unknownList)
					edgeLists = [
						edge1 = [
...
def ReadFile(fname):
	...
	if (deflatedTermSize != len(deflatedTermBytes)):
		return False
